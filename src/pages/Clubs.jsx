        ...
        <div className="flex flex-col min-h-full bg-sport-sky overflow-x-hidden">
            ...
            <div className="w-full h-[450px] bg-slate-200 border-b border-sport-sand relative z-10">
                <MapContainer
                    ...
                    zoomControl={false}
                    style={{ height: '450px', width: '100%', background: '#F0F7FF' }}
                >
                    <TileLayer
            ...
            <div className="flex-1 bg-sport-sky p-6 space-y-6 pb-40">
                ...
                <div className="space-y-4">
                    {clubs.map(club => (
                        ...
                        >
                            <div className="w-12 h-12 rounded-xl bg-sport-navy flex items-center justify-center text-white mr-4 overflow-hidden shadow-inner">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tighter">{club.city}, {club.country}</p>
                            </div>
            ...
            {selectedClub && (
                <div className="fixed inset-0 z-[1000] flex items-end justify-center p-4 pb-10" onClick={() => setSelectedClub(null)}>
                    ...
                    <div className="relative w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl p-8 animate-in slide-in-from-bottom duration-300 border-t border-sport-sky" onClick={e => e.stopPropagation()}>
                        <div className="flex justify-between items-start mb-6">
                            <h2 className="text-2xl font-black text-sport-navy leading-none">{selectedClub.name}</h2>
                            <button onClick={() => setSelectedClub(null)} className="p-2 bg-sport-sky rounded-full"><X size={18} /></button>
                        </div>
                        <p className="text-sm text-slate-500 mb-6 italic">{selectedClub.description || 'Pas de description.'}</p>
                        <div className="bg-sport-sky/50 p-5 rounded-2xl border border-sport-sand">
            ...
            {showRequestForm && (
                <div className="fixed inset-0 z-[1000] flex items-center justify-center p-6">
                    ...
                    <div className="relative bg-white w-full max-w-sm rounded-[3rem] p-10 shadow-2xl" onClick={e => e.stopPropagation()}>
                        <h2 className="text-2xl font-black text-sport-navy mb-1 uppercase tracking-tighter">Inscription</h2>
                        <p className="text-[10px] text-slate-400 font-bold uppercase mb-8 tracking-widest">Envoi au circuit Elite</p>
                        <form onSubmit={handleSubmitRequest} className="space-y-4">
                            <div className="space-y-1">
                                <label className="text-[9px] font-black text-sport-navy uppercase tracking-widest ml-4 mb-2 block">Identité du Club</label>
                                <input 
                                    placeholder="Nom complet" 
                                    className="w-full p-4 bg-sport-sky/50 rounded-2xl border border-sport-sand text-sm font-bold placeholder:text-slate-300 focus:bg-white transition-colors outline-none"
                            ...
                            <div className="space-y-1">
                                <label className="text-[9px] font-black text-sport-navy uppercase tracking-widest ml-4 mb-2 block">Contact Officiel</label>
                                <input 
                            ...
                            <button className="w-full py-5 bg-sport-navy text-white rounded-[1.5rem] font-black text-[10px] uppercase tracking-[0.4em] shadow-xl mt-4 active:scale-95 transition-all">Envoyer</button>
                        </form>
                    </div>
                </div>
            )}
